...
if (localStorage.getItem("bestBrain")) {                                                                                                                                  
    for (let i = 0; i < cars.length; i++) {
        ...
        if (i != 0) {
            NeuralNetwork.mutate(cars[i].brain, 0.99);
        }
    }
}
...
const traffic = [
    ...
    new Car(road.getLaneCenter(3), -200, 30, 50, "DUMMY", 2, getRandomColor()),
    ...
    new Car(road.getLaneCenter(3), -400, 30, 50, "DUMMY", 2, getRandomColor()),
    new Car(road.getLaneCenter(3), -500, 30, 50, "DUMMY", 2, getRandomColor()),
];
